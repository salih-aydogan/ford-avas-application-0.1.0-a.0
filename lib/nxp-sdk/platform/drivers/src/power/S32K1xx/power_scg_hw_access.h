 ...
 */
static inline bool POWER_SCG_GetSpllStatus(const SCG_Type* const base)
{
 ...
 */
static inline bool POWER_SCG_GetFircStatus(const SCG_Type* const base)
{
 ...
 */
static inline bool POWER_SCG_GetSoscStatus(const SCG_Type* const base)
{
