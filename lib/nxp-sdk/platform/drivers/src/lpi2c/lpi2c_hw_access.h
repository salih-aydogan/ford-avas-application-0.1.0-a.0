 ...
 * 
 * This function clears the all status flags. This events must be cleared 
 * before the LPI2C master can initiate a START condition.
 * 
 * @param baseAddr  base address of the LPI2C module
 */
static inline void LPI2C_Clear_MasterAllEvents(LPI2C_Type *baseAddr)
{
    baseAddr->MSR = ((uint32_t)0x7FU << LPI2C_MSR_EPF_SHIFT);
}
