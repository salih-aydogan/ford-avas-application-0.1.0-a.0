...
#ifndef TEST
#define CAN0_BASE           (0x40024000u) /*!< Peripheral base address in the alias region                                */
#else
extern uint8_t allocated_area[PERIPH_MEM_SIZE];
#define CAN0_BASE (allocated_area)
#endif /*TEST*/
...
#else
extern uint8_t allocated_area[PERIPH_MEM_SIZE];
#define DMA_BASE (allocated_area)
#endif /*TEST*/
...
#else
extern uint8_t allocated_area[PERIPH_MEM_SIZE];
#define PTE_BASE (allocated_area)
#endif /*TEST*/
...
/* GPIO - Peripheral instance base addresses */
/** Peripheral PTA base address */
#define PTA_BASE                                 (allocated_area)
/** Peripheral PTA base pointer */
#define PTA                                      ((GPIO_Type *)PTA_BASE)
/** Peripheral PTB base address */
#define PTB_BASE                                 (allocated_area + 0x40)
/** Peripheral PTB base pointer */
#define PTB                                      ((GPIO_Type *)PTB_BASE)
/** Peripheral PTC base address */
#define PTC_BASE                                 (allocated_area + 0x80)
/** Peripheral PTC base pointer */
#define PTC                                      ((GPIO_Type *)PTC_BASE)
/** Peripheral PTD base address */
#define PTD_BASE                                 (allocated_area + 0xC0)
/** Peripheral PTD base pointer */
#define PTD                                      ((GPIO_Type *)PTD_BASE)
/** Peripheral PTE base address */
#define PTE_BASE                                 (allocated_area + 0x100)
/** Peripheral PTE base pointer */
#define PTE                                      ((GPIO_Type *)PTE_BASE)
/** Array initializer of GPIO peripheral base addresses */
#define GPIO_BASE_ADDRS                          { PTA_BASE, PTB_BASE, PTC_BASE, PTD_BASE, PTE_BASE }
...
/* PORT - Peripheral instance base addresses */
/** Peripheral PORTA base address */
#define PORTA_BASE                               (allocated_area)
/** Peripheral PORTA base pointer */
#define PORTA                                    ((PORT_Type *)PORTA_BASE)
/** Peripheral PORTB base address */
#define PORTB_BASE                               (allocated_area + 0x1000U)
/** Peripheral PORTB base pointer */
#define PORTB                                    ((PORT_Type *)PORTB_BASE)
/** Peripheral PORTC base address */
#define PORTC_BASE                               (allocated_area + 0x2000U)
/** Peripheral PORTC base pointer */
#define PORTC                                    ((PORT_Type *)PORTC_BASE)
/** Peripheral PORTD base address */
#define PORTD_BASE                               (allocated_area + 0x3000U)
/** Peripheral PORTD base pointer */
#define PORTD                                    ((PORT_Type *)PORTD_BASE)
/** Peripheral PORTE base address */
#define PORTE_BASE                               (allocated_area + 0x4000U)
/** Peripheral PORTE base pointer */
#define PORTE                                    ((PORT_Type *)PORTE_BASE)
/** Array initializer of PORT peripheral base addresses */
#define PORT_BASE_ADDRS                          { PORTA_BASE, PORTB_BASE, PORTC_BASE, PORTD_BASE, PORTE_BASE }
...
#else
extern uint8_t allocated_area[PERIPH_MEM_SIZE];
#define RCM_BASE (allocated_area)
#endif /*TEST*/
...
#else
extern uint8_t allocated_area[PERIPH_MEM_SIZE];
#define S32_SCB_BASE (allocated_area)
#endif /*TEST*/
