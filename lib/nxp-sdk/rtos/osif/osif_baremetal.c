...
/*FUNCTION**********************************************************************
 *
 * Function Name : osif_systick_init
 * Description   : This function inits the systick counter.
 *
 * Implements : osif_UpdateTickConfig
 *END**************************************************************************/
void osif_systick_init(void)
{
...
{
    /*This function was commented because it's not desired to init the systick 
    at every delay operation.*/
    // osif_UpdateTickConfig(); 
