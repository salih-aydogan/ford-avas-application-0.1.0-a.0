...
/* Boolean */
#define TEST_ASSERT(condition)                                                                     UNITY_TEST_EQUAL_ASSERT_WITH_LOG((condition), __LINE__, "= True", " Expression Evaluated To FALSE")
#define TEST_ASSERT_TRUE(condition)                                                                UNITY_TEST_EQUAL_ASSERT_WITH_LOG((condition), __LINE__, "= True", " Expected TRUE Was FALSE")
#define TEST_ASSERT_UNLESS(condition)                                                              UNITY_TEST_EQUAL_ASSERT_WITH_LOG(!(condition), __LINE__, "= False", " Expression Evaluated To TRUE")
#define TEST_ASSERT_FALSE(condition)                                                               UNITY_TEST_EQUAL_ASSERT_WITH_LOG(!(condition), __LINE__, " Expected FALSE Was TRUE")
#define TEST_ASSERT_NULL(pointer)                                                                  UNITY_TEST_ASSERT_NULL_WITH_LOG((pointer), __LINE__, "= True", " Expected NULL")
#define TEST_ASSERT_NOT_NULL(pointer)                                                              UNITY_TEST_ASSERT_NOT_NULL_WITH_LOG((pointer), __LINE__, "= True", " Expected Non-NULL")
...
#define TEST_ASSERT_EQUAL(expected, actual)                                                        UNITY_TEST_ASSERT_EQUAL_INT_NEW_LINE((expected), (actual), __LINE__, NULL)
