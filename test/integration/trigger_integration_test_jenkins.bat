@echo off
Rem=============================================================================
Rem          FILE: trigger_integration_test_jenkins.bat
Rem
Rem   USAGE-1(Branch is automatically get from current folder): 
Rem   Bash trigger_integration_test_jenkins.bat
Rem
Rem   USAGE-2(Branch is manually selected): 
Rem   Bash trigger_integration_test_jenkins.bat master
Rem
Rem   DESCRIPTION: To trigger integration Tests on Jenkins and  
...
echo "Triggering Jenkins integration Tests..."
